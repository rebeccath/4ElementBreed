                            ...
                            case 4://Breed
                                ...
                                switch (choice) {
                                    case 1:
                                        ...
                                        if (allcreatures.get(c1).step != 1 || allcreatures.get(c2).step != 1) {
                                        ...
                                        if(allcreatures.get(c1).sex == allcreatures.get(c2).sex){
                                        ...
                                        case 2:
                                            ...
                                            if (allcreatures.get(c1).step != 2 || allcreatures.get(c2).step != 2) {
                                                System.out.println("***Die gewählten Kreaturen haben die falsche Stufe!");
                                                break;
                                            }
                                            if (c1>allcreatures.size()-1 || c2>allcreatures.size()-1) {
                                            ...
                                            case 3:
                                                ...
                                                c1 = Navigate.number("Wähle Kreatur 1\n>");
                                                c2 = Navigate.number("Wähle Kreatur 2\n>");
                                                if (allcreatures.get(c1).step != 3 || allcreatures.get(c2).step != 3) {
                                                    System.out.println("***Die gewählten Kreaturen haben die falsche Stufe!");
                                                    break;
                                                }
                                                if (c1>allcreatures.size()-1 || c2>allcreatures.size()-1) {
